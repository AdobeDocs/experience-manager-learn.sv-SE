...
+ Administration {#administration}
   + [Förstå skälen att uppgradera AEM](./administration/understand-reasons-to-upgrade.md)
   ...
   + [Implementera URL-omdirigeringar som är fria från pipeline](./administration/implementing-pipeline-free-url-redirects.md)
...
+ Utveckling {#development}
   ...
   + [Konfigurera en lokal AEM Development Environment](./development/set-up-a-local-aem-development-environment.md)
...
+ Projekt {#projects}
   + [Utveckla AEM-projekt](./projects/develop-aem-projects.md)
...
+ Felsökning {#troubleshooting}
   ...
   + [Tvinga omkompilering i AEM6.4](./troubleshooting/how-to-force-recompilation.md)
   + [Hur man undersöker indexeringsrelaterade problem i AEM](./troubleshooting/how-to-investigate-indexing-related-issues.md)
   + [Hur man undersöker SAML-relaterade problem i AEM](./troubleshooting/how-to-investigate-saml-related-issues.md)
   + [Hur man undersöker sökrelaterade problem i AEM](./troubleshooting/how-to-investigate-search-related-issues.md)
