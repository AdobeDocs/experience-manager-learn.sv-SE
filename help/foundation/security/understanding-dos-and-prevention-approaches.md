...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="https://experienceleague.adobe.com/sv/docs/experience-manager-learn/cloud-service/security/traffic-filter-and-waf-rules/examples-and-analysis#waf-rules" target="_blank">Utökad säkerhet (tidigare WAF-DDoS-skydd) licens</a></td>
