...
Utforska AEM Headless GraphQL API:er och filtrera data med en JavaScript-app som använder [jQuery](https://jquery.com/) och [Handlebars](https://handlebarsjs.com/). Den här appen skapar en lista med WKND-äventyr som kan filtreras efter aktivitetstyp.
