...
Nedan följer exempel på möjliga strategier för att skapa URL:er för [AEM GraphQL API](#aem-graphql-api-requests) och [bildbegäranden](#aem-image-requests) för flera populära headless-ramverk och plattformar.
