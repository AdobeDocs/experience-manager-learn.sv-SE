...
Minska risken för säkerhetsintrång är en högsta prioritet för alla organisationer. AEMCS erbjuder funktionen för trafikfilterregler, inklusive WAF-regler, för att skydda webbplatser och applikationer.
...
Den här självstudiekursen vägleder dig genom processen att skapa, driftsätta, testa och analysera resultaten av trafikfilterregler, inklusive WAF-regler.

>[!IMPORTANT]
>
> Underkategorin för trafikfilterregler som kallas &quot;WAF-regler&quot; kräver en licens för WAF-DDoS-skydd
