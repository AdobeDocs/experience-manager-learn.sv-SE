...
>[!CAUTION]
>
> Det här kodexemplet är bara för [Flexibla portägg](../flexible-port-egress.md). Ett liknande men annat kodexempel finns för [HTTP/HTTPS-anslutningar på icke-standardportar för dedikerad IP-adress och VPN](./http-on-non-standard-ports.md).
