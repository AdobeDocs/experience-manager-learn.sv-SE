---
title: HTTP/HTTPS-anslutningar på icke-standardportar
description: Lär dig hur du gör HTTP/HTTPS-begäranden från AEM as a Cloud Service till externa webbtjänster som körs på icke-standardportar.
...
# HTTP/HTTPS-anslutningar på icke-standardportar
