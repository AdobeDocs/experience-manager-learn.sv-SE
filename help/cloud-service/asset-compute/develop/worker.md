...
1. AEM Author anropar Asset compute-arbetaren, förutsatt att resursens __(1a)__ original binary (`source` parameter), och __(1b)__ alla parametrar som definierats i Bearbetningsprofilen (`rendition.instructions` parameter).
