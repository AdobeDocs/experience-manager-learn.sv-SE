...
+ __Upplösning:__ Ladda ned en ny `console.json` från ditt Adobe I/O-projekt
   ...
   1. Tryck på __Hämta__ knappen längst upp till höger
...
+ __Orsak:__ Felsökningsprogrammet för VS-koden kopplades inte innan användaren knackade __Kör__ i utvecklingsverktyget.
...
+ __Fel__: Felsökningskonsolen rapporterar &quot;Åtgärd timeout in -XXX millisekunder&quot; eller [asset compute Development Tool&#39;s](./develop/development-tool.md) förhandsgranskning av återgivning snurrar oändligt eller
+ __Orsak__: Arbetarens tidsgräns enligt definitionen i [manifest.yml](./develop/manifest.md) har överskridits under felsökning.
+ __Upplösning__: Öka arbetarens timeout tillfälligt i [manifest.yml](./develop/manifest.md) eller snabba upp felsökningen.
