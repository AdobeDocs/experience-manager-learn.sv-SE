...
Lär dig hur du integrerar Asset compute-arbetare med AEM as a Cloud Service genom att först distribuera dem till Adobe I/O Runtime och sedan starta från AEM as a Cloud Service författare via AEM Assets bearbetningsprofiler.
