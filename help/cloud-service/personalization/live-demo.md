---
title: Live Demo av användningsexempel från Personalization
...
### Home, Adventures och Magazine Pages
...
| Sida | Vad du kommer att se | Testa | Upplevelse |
|------|-----------------|-------------|------------|
...
WKND:s startsidas hjältebanner är personaliserad och bygger på autentiserade användarprofiler. Testa med dessa demokonton för att se en personaliserad upplevelse:

| Sida | Vad du kommer att se | Testa | Profilkontext | Upplevelse |
|------|-----------------|-------------|-----------------|------------|
| [Startsida](https://wknd.enablementadobe.com/us/en.html){target="wknd"} | En skidverkets insida med **premiumskidutrustning med erbjudandet&quot;EXTRA 25 % OFF&quot;**, med experttips för att förbereda sig för det kommande skidäventyret | Logga in med `teddy/teddy` eller `asmith/asmith` och uppdatera sidan | Nyligen köpta skidäventyr, och därmed sälja skidutrustning | ![Home - Ski Gear Upsell](./assets/live-demo/known-user-ski-gear-hero.png){width="200" zoomable="yes"} |

**Läs mer:** Vill du implementera en användaranpassad AEM-webbplats? Börja med självstudiekursen för [kända användare av Personalization](./use-cases/known-user-personalization.md) för att lära dig hela installationsprocessen.

## A/B-testning (experimentering)
