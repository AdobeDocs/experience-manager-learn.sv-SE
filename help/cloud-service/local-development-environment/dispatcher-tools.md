...
Körs `docker_run` i Windows kan resultera i följande fel, vilket förhindrar att Dispatcher startas. Detta är ett rapporterat problem med Dispatcher i Windows och kommer att åtgärdas i en framtida version.
