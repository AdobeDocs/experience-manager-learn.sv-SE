...
Det här exemplet AEM tillägget Content Fragment Console är ett [åtgärdsfält](../action-bar.md) tillägg som satsvis uppdaterar en Content Fragment-egenskap till ett gemensamt värde.
