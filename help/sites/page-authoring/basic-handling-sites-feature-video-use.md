...
* Panelen Global navigering består av:
   * Navigering - motsvaras av en kompass
     ...
     | Konsol | Syfte |
     |---|---|
     | Assets | Med dessa konsoler kan du importera och hantera digitala resurser som bilder, videoklipp, dokument och ljudfiler. Dessa resurser kan sedan användas av alla webbplatser som körs på samma AEM-instans |
     | Communities | Med den här konsolen kan du skapa och hantera communitysajter för engagemang och aktivering |
     | Commerce | På så sätt kan du hantera produkter, produktkataloger och beställningar för dina Commerce-webbplatser |
