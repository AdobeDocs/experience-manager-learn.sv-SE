...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td valign="middle">→</td> 
   <td><p><span class="code">.cmp-list—dark</span></p> <p><span class="code"> .cmp-list</span></p> <p><span class="code"> </span><strong><span class="code"> .cmp-list_item </span></strong></p> <p><strong> färg: blå,</strong></p> <p><strong> &rbrace;</strong></p> </td> 
  </tr> 
  <tr> 
