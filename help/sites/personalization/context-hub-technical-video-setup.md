...
>[!NOTE]
>
>Vi använder WKND-referenswebbplatsen för den här videon och den ingår inte i AEM-versionen. Du kan hämta den [senaste versionen här](https://github.com/adobe/aem-guides-wknd/releases).
...
Skapa AEM-segment som fungerar som regler för lärarna. Det innebär att de definierar när innehåll inom ett suddgummi visas på en webbsida. Innehållet kan sedan anpassas efter besökarens behov och intressen, beroende på vilket segment som de matchar.
