        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2 minuter</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="author-authentication.md" title="Autentisering av författare">Autentisering av författare</a>
            </p>
            <p class="is-size-6">Lär dig hur du konfigurerar autentisering av författare.</p>
