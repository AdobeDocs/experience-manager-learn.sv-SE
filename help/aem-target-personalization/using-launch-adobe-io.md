...
description: Steg för steg gå igenom hur du kan integrera Adobe Experience Manager med Adobe Target med hjälp av Experience Platform Launch och Adobe I/O
seo-description: Steg för steg gå igenom hur du kan integrera Adobe Experience Manager med Adobe Target med hjälp av Experience Platform Launch och Adobe I/O
...
* [AEM författare och publicera instans](./implementation.md#set-up-aem) som körs på localhost-port 4502 respektive 4503
* **Experience Cloud**
   ...
   * Experience Cloud tillhandahålls med följande lösningar
      ...
      * [Adobe I/O-konsol](https://console.adobe.io)
...
3. I lösningsväljaren klickar du på **Starta** och väljer sedan **Gå till start** .
...
4. Se till att du är i rätt organisation och fortsätt sedan att skapa en Launch-egenskap.
   ...
   *Mer information om hur du skapar egenskaper finns i[Skapa en egenskap](https://docs.adobelaunch.com/administration/companies-and-properties#create-a-property)i produktdokumentationen.*
5. Klicka på knappen **Ny egenskap**
6. Ange ett namn för egenskapen (till exempel *AEM mållustration*)
7. Som domän anger du *localhost.com* eftersom det är den domän där WKND-demowebbplatsen körs. Trots att fältet *Domän* krävs fungerar egenskapen Launch på alla domäner där det implementeras. Det främsta syftet med det här fältet är att förifylla menyalternativ i regelbyggaren.
...
1. Under **Tillägg** kan du se en lista över tillägg som redan är installerade för Launch-egenskapen. ([Experience Platform Launch Core Extension](https://exchange.adobe.com/experiencecloud.details.100223.adobe-launch-core-extension.html) installeras som standard)
2. Klicka på alternativet **Tilläggskatalog** och sök efter Mål i filtret.
3. Välj den senaste versionen av Adobe Target at.js och klicka på **Installera** .
...
5. Klicka på **Spara** för att lägga till måltillägget i Launch-egenskapen och du bör nu kunna se måltillägget som listas i listan **Installerade** tillägg.
...
1. Klicka på fliken **Miljö** för platsegenskapen, så ser du en lista över den miljö som skapas för platsegenskapen. Som standard har vi en instans som skapats för utveckling, staging och produktion.
...
5. Kör till sist alternativet **Skapa och publicera i produktion** för att överföra ändringarna till produktionen.
...
>[!NOTE]
>
> Ge Adobe I/O-integrering åtkomst till utvalda arbetsytor med rätt [roll så att ett centralt team kan göra API-drivna ändringar på bara några få arbetsytor](https://docs.adobe.com/content/help/en/target/using/administer/manage-users/enterprise/configure-adobe-io-integration.html).

1. Skapa IMS-integrering i AEM med hjälp av autentiseringsuppgifter från Adobe I/O. (01:12 till 03:55)
2. Skapa en egenskap i Experience Platform Launch. (som omfattas [ovan](#create-launch-property))
...
Nu har du integrerat [AEM med Adobe Target med Adobe Experience Platform Launch](./using-aem-cloud-services.md#integrating-aem-target-options) , vilket beskrivs i Alternativ 1.
