...
description: Från och med AEM Forms 6.5.1 har vi nu möjlighet att samla in felmeddelanden som genererats när vi använder anropa Form Data Model Service som ett steg i AEM Workflow. Arbetsflöde.
feature: Workflow
