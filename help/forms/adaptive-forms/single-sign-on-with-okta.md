...
Ange följande egenskaper enligt nedanFöljande nyckelegenskaper måste anges:
...
* **Synkroniserade attribut** - Det här är attributen som lagras från SAML-försäkran i AEM profil
...
* **Tillåt Regexp-värd**: IdP:s värdnamn (kommer att vara ett annat namn i ditt fall)Egenskaperna för Sling Referrer-filtret, bild
