...
# Skapa en servett för att lagra formulärdata

Nästa steg är att skapa en serverlet som antingen infogar eller uppdaterar formulärdata. Den grupperade DataSource för Apache Sling-anslutningen som konfigurerats i föregående steg refereras på rad 26. Resten av koden är relativt okomplicerad. Koden infogar antingen en ny rad i databasen eller uppdaterar en befintlig rad. Lagrade data för anpassningsbara formulär är kopplade till ett GUID. Samma GUID används sedan för att uppdatera formulärdata.
