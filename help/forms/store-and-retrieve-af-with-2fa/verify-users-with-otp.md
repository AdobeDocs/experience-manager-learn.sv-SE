...
Skapa ett utvecklarkonto hos [Nexmo](https://dashboard.nexmo.com/sign-in). Anteckna API-nyckeln och API-hemlig nyckel. Dessa nycklar behövs för att anropa REST API:er för Nexmo-tjänsten.
...
* Åtgärdsparametrar Indata och utdata för varje operationAuthentication-metod
...
Följ dokumentationen för [OpenAPI för att skapa din första swagger/OpenAPI-fil](https://swagger.io/docs/specification/2-0/basic-structure/)

>[!NOTE]
> AEM Forms stöder OpenAPI Specification version 2.0 (fka Swagger).

Använd [swagger-redigeraren](https://editor.swagger.io/) för att skapa en swagger-fil som beskriver de åtgärder som skickar och verifierar engångslösenord som skickas med SMS. Swagger-filen kan skapas i JSON- eller YAML-format. Den färdiga swagger-filen kan hämtas [här](assets/two-factore-authentication-swagger.zip)

## Skapa datakälla

För att kunna integrera AEM/AEM Forms med program från tredje part måste vi [REST-baserad datakälla använda swagger-filen](https://docs.adobe.com/content/help/en/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html) i molntjänstkonfigurationen. Den färdiga datakällan tillhandahålls som en del av kursmaterialet.
...
Den ifyllda formulärdatamodellen kan [laddas ned härifrån](assets/sms-2fa-fdm.zip)
