---
title: Skapa OSGi-konfiguration
description: Ange konfigurationsinställningar för Azure Portal med OSGi-konfiguration.
...
[Skriva förifyllningstjänst](./create-prefill-service.md)
